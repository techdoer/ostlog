...
(
	...
	[repeat_bounds_range_start_date] INT DEFAULT CONVERT (char(8), GETDATE(), 112) NULL,
	...
	CONSTRAINT [PK_Timing schedules] PRIMARY KEY CLUSTERED ([id] ASC),

	-- start FHIR type constraints 
	CONSTRAINT [FK_Timing schedules-Calendar_dates1] FOREIGN KEY ([event_date_id]) REFERENCES [dbo].[Calendar dates] ([date_id]),
	CONSTRAINT [FK_Timing schedules-Calendar_dates2] FOREIGN KEY ([repeat_bounds_range_start_date]) REFERENCES [dbo].[Calendar dates] ([date_id]),
	CONSTRAINT [FK_Timing schedules-Calendar_dates3] FOREIGN KEY ([repeat_bounds_range_end_date]) REFERENCES [dbo].[Calendar dates] ([date_id]),
