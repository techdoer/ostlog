...
(
	...
	[azotemia_mg_%] FLOAT NULL,
	[glucose_mg_dL] FLOAT NULL,
	[glycosylated hemoglobin_%] FLOAT NULL,
	...
	[transglutaminase_IgA_U_ml] FLOAT NULL,
	[helicobacter_pylori_IgA_index] FLOAT NULL,
	[helicobacter_pylori_IgG_UA_ml] FLOAT NULL,
	[tsh_uu_mL] FLOAT NULL,
	[t3_pmol_L] FLOAT NULL, 
	[t4_pmol_L] FLOAT NULL,
	[t4_free_ng_dl] FLOAT NULL,
	[amylase_U_l] FLOAT NULL,
	[potassium_meq_L] FLOAT NULL, 
	[magnesium_meq_L] FLOAT NULL,
	[sodium_meq_L] FLOAT NULL, 
	[calcium_meq_L] FLOAT NULL, 
	[chloride_meq_L] FLOAT NULL,
	[proteine_total_g_%] FLOAT NULL,
